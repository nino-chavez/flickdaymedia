...
import { page, outroCard, wordmark, playIcon, renderJobs } from './_brand-v2.mjs'
...
const lockupTransparent = () =>
  page(`<div style="position:absolute;inset:0;display:flex;align-items:center;justify-content:center">${wordmark(620, { color: '#ffffff' })}</div>`,
    { w: 1100, h: 300, alpha: true })

const playGlyphTransparent = () =>
...
const jobs = [
  ...
  { name: 'play-glyph-transparent', w: 512, h: 512, alpha: true, html: playGlyphTransparent(), scale: 2 },
]
...
for (const old of ['aperture-icon-transparent.png', 'motion-icon-transparent.png', 'f-glyph-transparent.png', 'k-glyph-transparent.png', 'fd-glyph-transparent.png']) {
